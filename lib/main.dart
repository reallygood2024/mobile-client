...
class MyHomePage extends StatefulWidget {
  ...
  @override
  State<MyHomePage> createState() => _isLogin ? _MyHomePageState() : _MyLoginPageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        // This will show the hamburger icon on the left side
        // And user can click it to summon the menu
